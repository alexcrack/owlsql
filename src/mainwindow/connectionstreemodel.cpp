...
QModelIndex ConnectionsTreeModel::addConnection(DbConnection *connection, const QModelIndex &parent)
{
    beginInsertRows(QModelIndex(), 0, 0);

    rootItem->appendChild(new ServerTreeItem(connection, rootItem));
