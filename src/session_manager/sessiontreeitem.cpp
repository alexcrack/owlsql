...
{;
    ...
    m_queryTimeOut = 60;
    m_pingTimeOut = 60;
    m_clientTimeZone = QString("");
    m_fullTableStatus = QString("");
}
    ...
    : TreeItem(parentItem)
{
    ...
    m_clientTimeZone = sessionObject.value("clientTimeZone").toString();
    m_fullTableStatus = sessionObject.value("fullTableStatus").toString();
}
...
bool SessionTreeItem::setData(int column, const QVariant &data)
{
    ...
    case Field::PingTimeOut:
        ...
        break;
    case Field::ClientTimeZone:
        m_clientTimeZone = data.toString();
        break;
    case Field::FullTableStatus:
        m_fullTableStatus = data.toString();
        break;
    default:
        return false;
    }
